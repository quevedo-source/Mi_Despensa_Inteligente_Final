...
## Sitio web
El proyecto Mi despensa inteligente surge con el fin de ofrecer una solución innovadora frente al desperdicio de alimentos ya que puede contribuir a una mejor gestión de los recursos alimenticios. proponiendo una aplicación web intuitiva y funcional que ayude al usuario a organizar su despensa, controlar su vigencia y recibir notificaciones oportunas. La aplicación está dirigida a personas que cocinan en casa y familias que desean optimizar el consumo de alimentos.
<img width="781" height="288" alt="image" src="https://github.com/user-attachments/assets/232f266c-2a18-4a4b-8bf9-7c66264c8f02" />
...
Características:
- Permite ingresar manualmente productos con nombre, cantidad y fechas de caducidad.
- Sistemas de notificaciones por correo, móvil o la web cuando se acerca el vencimiento de un producto.
